...
### Model Selection ###
# Default model used by main.py/single_run.py.
# Set this to another model name (e.g. 'ppdisk1') in a config to override.
model_name     = 'ppdisk_complete'
...
sig_vortex_amp           = [0.0, 0.0]                 # Amplitude of vortex density enhancement
sig_vortex_phi0          = [0, "pi"]                  # Azimuthal location of vortex center for density (radians)
sig_vortex_r0            = ['80.0*au', '80.0*au']     # Radial location of vortex center for density
sig_vortex_width_phi     = [0.1, 0.1]                 # Azimuthal width of vortex for density (radians)
sig_vortex_width_r       = ['5.0*au','5.0*au']        # Radial width of vortex for density

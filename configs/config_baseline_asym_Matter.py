"""
Reference Configuration: Asymmetric Baseline with Matter Model
"""
...
### Model Selection ###
model_name     = 'ppdisk_matter'

### ppdisk1 Inner-Rim Smoothing ###
# Smooth transition in scale height from r_in -> r1 and smooth density taper around rin.
r_in           = '2.17*au'
r1             = '3.4*au'
h_in           = '0.0035*au'
rim_smooth_width = '0.18*au'
...
nw             = [30, 30, 20, 30, 30]
xbound         = ['0.02*au', '2.16*au', '2.22*au', '190*au', '220*au']
nx             = [160, 900, 240, 160]

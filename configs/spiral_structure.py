...
nphot_scat     = '5e+7'            # Number of Photons for Scattering
...
scattering_mode_max =  1          # Scattering Mode (0=None, 1=Isotropic, 2=Anisotropic)
...
#Spiral structures
h_spiral_amp             = 0.4                        # Amplitude of spiral scale height variation
sig_spiral_amp           = 0.8                        # Amplitude of spiral density variation
spiral_pitch             = 0.8                       # Pitch angle of spiral structure (used for both h and sig)
n_arms                   = 2                          # Number of spiral arms
spiral_width_phi         = 0.3                       # Azimuthal width of spiral arms
spiral_sharpness         = 2                          # Sharpness of spiral structures (>1 uses tanh profile)

# Vortex Strucutures
h_vortex_amp             = [0.9, 0.9]                 # Amplitude of vortex scale height enhancement
h_vortex_phi0            = [0, "pi"]                  # Azimuthal location of vortex center for scale height (radians)
h_vortex_r0              = ['5.0*au', '5.0*au']     # Radial location of vortex center for scale height
h_vortex_width_phi       = [0.05, 0.05]                 # Azimuthal width of vortex for scale height (radians)
h_vortex_width_r         = ['0.5*au','0.5*au']        # Radial width of vortex for scale height
sig_vortex_amp           = [0.9, 0.9]                 # Amplitude of vortex density enhancement
sig_vortex_phi0          = [0, "pi"]                  # Azimuthal location of vortex center for density (radians)
sig_vortex_r0            = ['5.0*au', '5.0*au']     # Radial location of vortex center for density
sig_vortex_width_phi     = [0.05, 0.05]                 # Azimuthal width of vortex for density (radians)
sig_vortex_width_r       = ['0.5*au','0.5*au']        # Radial width of vortex for density
